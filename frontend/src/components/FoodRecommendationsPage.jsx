...
function FoodRecommendationsPage({ user }) {
  ...
  const renderMealPlan = () => {
    ...
    if (recommendations?.meal_plan) {
      return renderStructuredMealPlan();
    }
    ...
    return (
      <div className="mt-4">
        <div className="alert alert-warning">
          <h6>⚠️ No meal plan data found</h6>
  ...
  const renderFallbackResponse = () => {
    const { response, daily_calories, goal } = recommendations;
  ...
  const renderStructuredMealPlan = () => {
    const { meal_plan, daily_calories, macronutrient_targets } = recommendations;
    ...
    return (
      <div className="mt-4">
        ...
        {(recommendations.hydration || recommendations.meal_prep_tips || recommendations.food_substitutions) && (
                  ...
                  <div className="row">
                    {recommendations.hydration && (
                      <div className="col-md-4 mb-3">
                        ...
                        <p className="small">{recommendations.hydration}</p>
                      </div>
                    )}
                    ...
                    {recommendations.food_substitutions && (
                      <div className="col-md-4 mb-3">
                        <h6 className="text-warning">
                          <i className="fas fa-exchange-alt me-2"></i>
                          Food Substitutions
                        </h6>
                        {Object.entries(recommendations.food_substitutions).map(([category, options]) => (
