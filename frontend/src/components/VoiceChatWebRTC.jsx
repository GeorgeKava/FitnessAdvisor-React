...
const VoiceChatWebRTC = ({ user }) => {
  ...
  const updateSession = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/get-session-configuration');
      if (!response.ok) {
  ...
  const handleFitnessRecommendation = async (args) => {
    try {
      const response = await fetch('/api/functions/get_fitness_recommendations', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleGetUserProfile = async (args) => {
    try {
      const response = await fetch('/api/functions/get_user_profile', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(args)
      });
  ...
  const handleGetProgressData = async (args) => {
    try {
      const response = await fetch('/api/functions/get_progress_data', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(args)
      });
  ...
  const handleGetTodaysPlan = async (args) => {
    try {
      const response = await fetch('/api/functions/get_todays_plan', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(args)
      });
