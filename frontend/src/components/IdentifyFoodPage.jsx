            ...
            <div className="card-body p-4">
              ...
              <div className="row mb-4">
                <div className="col-12 text-center">
                  <div className="btn-group" role="group" aria-label="Analysis type">
                    <button
                      type="button"
                      className={`btn ${analysisType === 'food' ? 'btn-primary' : 'btn-outline-primary'}`}
                      onClick={() => {
                        setAnalysisType('food');
                        setAnalysisResult(null); // Clear results when switching tabs
                        setError(null);
                        setSelectedImage(null); // Clear selected image
                        setShowCamera(false); // Hide camera if active
                        if (fileInputRef.current) {
                          fileInputRef.current.value = '';
                        }
                        if (stream) {
                    ...
                    <button
                      type="button"
                      className={`btn ${analysisType === 'ingredient' ? 'btn-primary' : 'btn-outline-primary'}`}
                      onClick={() => {
