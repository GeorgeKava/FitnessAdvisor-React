...
def handle_get_todays_plan():
    ...
    try:
        ...
        if not weekly_plan:
            ...
            if recommendations:
                return jsonify({
                    "message": f"I found your latest fitness recommendations (you have {len(recommendations)} total), but you haven't generated a weekly plan yet. You can create one by visiting the 'Weekly Plan' page or asking me to help you generate one based on your most recent recommendations.",
                    "plan": {},
                    "has_recommendations": True,
                    "recommendations_count": len(recommendations),
                    "suggestion": "Would you like me to help you generate a weekly plan based on your latest fitness recommendations?"
                })
            else:
                return jsonify({
...
def create_user_profile():
    """Create a new user profile and store in the user_data index"""
    try:
        data = request.json
